...
// Use TsconfigPathsPlugin so webpack picks up the `paths` mappings from `tsconfig.json` (e.g. "@/*").
// This keeps TypeScript and webpack resolving imports the same way without duplicating aliases.
...
module.exports = {
  ...
  resolve: {
    ...
    plugins: [
      // Read path mappings from tsconfig.json so imports like "@/components/..." resolve correctly.
